...
with cols1:
    months = ["Jan", "Fev", "Mar", "Avr", "Mai", "Juin", "Juillet", "Août", "Sept", "Oct", "Nov", "Dec"]
    ...
    'grid': {
        ...
        "xAxis": {
        "type": 'category',
        "data": ["Jan", "Fev", "Mar", "Avr", "Mai", "Juin", "Juillet", "Août", "Sept", "Oct", "Nov", "Dec"]
        },
        "yAxis": {
        "type": 'value'
        },
...
with col2:
    ...
    op = {
    "title": {
        "text": '# commande par Mode de Transport',
        'textStyle':{
            "fontSize": 14
        },   
        "top" :"10%",   
